...
const PricingHome = () => { 
  const mainPrice = 300; // Updated main price
  ...
  return ( 
      ...
      <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        Priserne for rengøringsservice i Aarhus koster fra{" "}
            <span className="text-3xl text-black sm:text-4xl md:text-5xl font-extrabold">240</span> Kr./time (ekskl. moms)
          </p>
          <div className="relative flex flex-col mt-16 lg:flex-row items-start justify-around w-full gap-8 sm:gap-12 md:gap-16 lg:gap-20">
            {/* Left Side - Form Inputs */}
            <div className="relative z-10 flex flex-col w-full lg:w-2/3 space-y-2 sm:space-y-1">
              {/* Frequency of Cleaning */}
              <div className="bg-white p-4 sm:px-4 rounded-lg shadow-sm">
