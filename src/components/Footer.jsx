        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 text-gray-400">
                <IoMail className="text-xl text-blue-500" />
                <a href="mailto:info@renklar.dk" className="hover:text-blue-500 transition-colors">
                  info@renklar.dk
                </a>
              </div>
              <div className="flex items-center space-x-3 text-gray-400">
                <BsClockFill className="text-xl text-blue-500" />
                <span>Man - Søn: 06:00 - 21:00</span>
              </div>
            </div>
          </div>
